...
void rotate4x4(mat4x4 mat_in, float angle, fvec *unit_vector, mat4x4 out)
{
...
void set_rotation4x4(mat4x4 rotation_matrix, float angle, fvec *unit_vector) // note angle in radians
{
    assert(unit_vector->size == 3);
    ...
    rotation_matrix[1][0] = (unit_vector->data.values[0] * unit_vector->data.values[1] * cos_a_n_1) - (unit_vector->data.values[2] * sin_a);
    rotation_matrix[2][0] = (unit_vector->data.values[0] * unit_vector->data.values[2] * cos_a_n_1) + (unit_vector->data.values[1] * sin_a);
    rotation_matrix[0][3] = 0;
    rotation_matrix[0][1] = (unit_vector->data.values[0] * unit_vector->data.values[1] * cos_a_n_1) + (unit_vector->data.values[2] * sin_a);
    rotation_matrix[1][1] = cos_a + (u_y2 * (cos_a_n_1));
    rotation_matrix[2][1] = (unit_vector->data.values[1] * unit_vector->data.values[2] * cos_a_n_1) - (unit_vector->data.values[0] * sin_a);
    rotation_matrix[1][3] = 0;
    rotation_matrix[0][2] = (unit_vector->data.values[2] * unit_vector->data.values[0] * cos_a_n_1) - (unit_vector->data.values[1] * sin_a);
    rotation_matrix[1][2] = (unit_vector->data.values[2] * unit_vector->data.values[1] * cos_a_n_1) + (unit_vector->data.values[0] * sin_a);
...
void set_lookat(fvec *pos, fvec *target, fvec *up, mat4x4 out)
{
