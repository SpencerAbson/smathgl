...
mat4x4 mat4_rotation(float angle, fvec *unit_vector) // note angle in radians
{
    ...
    rotation_matrix.values[2][3] = 0;
    rotation_matrix.values[3][0] = 0;
    rotation_matrix.values[3][1] = 0;
    rotation_matrix.values[3][2] = 0;
